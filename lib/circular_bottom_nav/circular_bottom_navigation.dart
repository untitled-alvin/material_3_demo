...
class _CircularBottomNavigationState extends State<CircularBottomNavigation>
  ...
  // final Curve _animationsCurve = Curves.linear;
  final Curve _animationsCurve = const Cubic(0.5, 1.21, 1, 1.09);
  ...
  Widget build(BuildContext context) {
    ...
    children.add(SizedBox(width: fullWidth, height: fullHeight));
